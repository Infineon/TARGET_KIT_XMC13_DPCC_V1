...
#
# \brief
# Define the KIT_XMC13_DPCC_V1 target.
#
################################################################################
# \copyright
...
MPN_LIST:=XMC1302-T038x0200
DEVICE:=XMC1302-T038x0200
DEVICE_COMPONENTS:=CAT3 XMC13XX
DEVICE_LIST:=XMC1302-T038x0200
DEVICE_TOOL_IDS:=bsp-assistant device-configurator library-manager memory-analyzer online-simulator project-creator
DEVICE_XMC1302-T038x0200_CORES:=CORE_NAME_CM0_0
DEVICE_XMC1302-T038x0200_DIE:=XMC1300
DEVICE_XMC1302-T038x0200_FLASH_KB:=200
DEVICE_XMC1302-T038x0200_SRAM_KB:=16
